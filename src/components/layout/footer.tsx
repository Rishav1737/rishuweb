...
import CalBookingModal from "@/components/sections/home/cal-booking-modal";
  ...
  return (
    <footer className="relative w-full overflow-hidden border-t pt-20 md:pt-32 pb-10">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 gap-12 border-t border-border/40 pt-12 md:grid-cols-12 md:gap-6">
          ...
          >
            ...
            <p className="max-w-xs text-muted-foreground text-sm leading-relaxed">
              A unified editor who creates suprising videos and motion edits!
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <SocialLink
                href="https://www.instagram.com/yourrishuuuu"
                icon={FaInstagram}
                label="Instagram"
              />
              <SocialLink
                href="https://discord.gg/imrishav_"
                icon={FaDiscord}
                label="Discord"
              />
            </div>
        ...
        >
          <p>© {currentYear} Rishab. All rights reserved.</p>
